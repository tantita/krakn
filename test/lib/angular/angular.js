 ...
 * 
 * <pre>
 * var krakn = angular.module('krakn', []);
 * krakn.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://krakn.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://krakn.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * <pre class="prettyprint">
 *    angular.module('krakn', []).config(function($sceDelegateProvider) {
 ...
 *        'http://krakn.example.com/clickThru**']);
 *      });
 * </pre>
 */
...
<file name="index.html">
  <div ng-controller="kraknController as myCtrl">
...
<file name="script.js">
  ...
  mySceApp.controller("kraknController", function kraknController($http, $templateCache, $sce) {
    var self = this;
 ...
 *
 * <pre class="prettyprint">
 *   angular.module('kraknWithSceDisabledkrakn', []).config(function($sceProvider) {
